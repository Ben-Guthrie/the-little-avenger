...
func play_intro():
	DialogueManager.show_dialogue_balloon(preload("res://globals/dialogue/intro.dialogue"), "level_6")
...
func _on_timmy_timmy_dies() -> void:
	paused = true
	DialogueManager.show_dialogue_balloon(preload("res://globals/dialogue/general.dialogue"), "level_6_death")
	await DialogueManager.dialogue_ended
